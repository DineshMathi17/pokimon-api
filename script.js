...
btnNext=results.next?`<button class="btn" data-url=${results.next}>Next</button>`: ''
btnPrevious=results.previous?`<button class="btn" data-url=${results.previous}>Previous</button>`: ''
